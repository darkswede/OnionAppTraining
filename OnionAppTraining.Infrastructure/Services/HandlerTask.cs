...
namespace OnionAppTraining.Infrastructure.Services
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<OnionException, Task> _onCustomError;
        ...
        public IHandlerTask OnCustomError(Func<OnionException, Task> onCustomError, bool propagateException = false, bool executeOnError = false)
        {
        ...
        {
            var customException = exception as OnionException;
